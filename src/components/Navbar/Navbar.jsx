...
import { faGlobe, faRightFromBracket, faRightToBracket } from '@fortawesome/free-solid-svg-icons';
    ...
    >
      ...
      <nav className={css.menu} ref={navEl}>
        <ul className={css['menu-list']}>
          ...
          {authToken?.token ? (
            <div
              className='flex sm:hidden gap-x-1 items-center'
              onClick={() => {
                navEl.current.classList.toggle(css.active);
                handleLogout();
              }}
      ...
      <div className='flex items-center relative'>
        ...
        <div className='relative mr-5' ref={ref}>
          ...
          {isComponentVisible && (
            <div className='absolute mt-3 bg-zinc-300 p-2 rounded -left-10 sm:left-auto sm:right-0'>
              {/* Worldwide Icon */}
              <div
